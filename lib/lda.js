...
//
var process = function(sentences, numberOfTopics, numberOfTermsPerTopic, languages, alphaValue, betaValue, specialCharacters) {
    ...
    lda.configure(documents,V,300, 30, 100, 10);
